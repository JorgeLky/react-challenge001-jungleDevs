...
function DetailsPageFooter() {
  return (
    <section className="details-page-footer">
      ...
      <button className="create-nanny" data-testid="create-nanny-button">
        <h3>Create Your nanny share</h3>
        <p>Takes less than 5 minutes</p>
      </button>
      <br />
      <Link className="browse-local-nanny">Or browse local nanny-shares</Link>
      <br />
      ...
      <nav>
        ...
        <Link>
          <img
            src={facebookIcon}
            data-testid="social-network-icon"
            alt="facebook icon"
